<h2><a href="https://www.geeksforgeeks.org/problems/subsets-1613027340/1?page=2&category=Recursion&difficulty=School,Basic,Easy,Medium&sortBy=submissions">Subsets</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a set of positive integers, find all its subsets.</span></p>
